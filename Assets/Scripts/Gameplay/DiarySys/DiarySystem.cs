...
public struct UIElements
{
    ...
    public TextMeshProUGUI Subscript => subscript;
    
    [SerializeField] private CanvasGroup subscriptGroup;
    public CanvasGroup SubscriptGroup => subscriptGroup;
        
    [SerializeField] private Image page;
    public Image Page => page;
    
    [SerializeField] private Image lines;
    public Image Lines => lines;
    
    [SerializeField] private CanvasGroup noteCanvasGroup;
    public CanvasGroup NoteCanvasGroup => noteCanvasGroup;

    [SerializeField] private CanvasGroup listCanvasGroup;
    public CanvasGroup ListCanvasGroup => listCanvasGroup;
    
    [SerializeField] private CanvasGroup readButton;
    public CanvasGroup ReadButton => readButton;

    [SerializeField] private CanvasGroup nextButton;
    public CanvasGroup NextButton => nextButton;
    
    [SerializeField] private CanvasGroup previousButton;
    public CanvasGroup PreviousButton => previousButton;
        
    [SerializeField] private NoteData noteDataPrefab;
    public NoteData NoteDataPrefab => noteDataPrefab;
    
    [SerializeField] private RectTransform listRect;
    public RectTransform ListRect => listRect;
...
public class DiarySystem : MonoBehaviour
{
    ...
    private Page ActivePage => activeNote.Pages[currentPage];
    ...
    private void Update()
    {
        if (controls.Controls.Diary.Diary.triggered)
        {
    ...
    private void SwitchGameControls(bool state)
    {
        ...
        {
            case true:
                controls.Controls.Player.Disable();
                Cursor.visible = true;
                Cursor.lockState = CursorLockMode.None;
                break;
            case false:
                controls.Controls.Player.Enable();
